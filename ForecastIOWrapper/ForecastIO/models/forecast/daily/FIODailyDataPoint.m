...
- (void)updateWithDictionary:(NSDictionary *)dictionary {
    ...
    self.precipIntensity = [dictionary[FIODailyDataPointPrecipIntensityKey] floatValue];
    self.precipIntensityMax = [dictionary[FIODailyDataPointPrecipIntensityMaxKey] floatValue];
